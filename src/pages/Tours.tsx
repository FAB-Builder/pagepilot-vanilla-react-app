        ...
        <Section id="show-once" title="Show only once">
          ...
          >
            <li className="flex gap-3">
              ...
              <span>
                Open the tour in <strong>Page Pilot → Tours</strong> and click{' '}
                <strong>Edit Design</strong> to enter the tour editor.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-brand text-[11px] font-bold text-white">
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                next time the tour is fetched — no code changes are needed on your end.
              </span>
            </li>
          </ol>
          <p id="show-once-where-note" className="mt-4">
            This is a per-tour setting authored in Page Pilot, not a parameter of{' '}
