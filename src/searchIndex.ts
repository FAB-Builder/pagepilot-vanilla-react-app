...
const MODULE_LABEL: Record<string, string> = {
  ...
  '/blocks/rating': 'Rating',
  '/blocks/accessibility-tools': 'Accessibility Tools',
  '/blocks/skip-link': 'Skip Link',
  '/blocks/menu-picker': 'Menu',
  '/blocks/forms-picker': 'Forms',
  '/blocks/demo-picker': 'Demo',
  '/blocks/app-banner-picker': 'App Banner',
  '/blocks/calendly': 'Calendly',
  '/blocks/timer': 'Timer',
